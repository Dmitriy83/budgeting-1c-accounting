...
Функция ПолучитьФактБюджетаДоходовИРасходов(Период)
	...
	Факт.Колонки.Добавить("НеРассчитыватьИтоги", Новый ОписаниеТипов("Булево")); 
	...
	|	СтатьиБюджетаДоходовИРасходов.ТекстЗапросаПолученияФакта КАК ТекстЗапросаПолученияФакта,
	|	СтатьиБюджетаДоходовИРасходов.ТипАналитики КАК ТипАналитики,
	|	СтатьиБюджетаДоходовИРасходов.НеРассчитыватьИтоги КАК НеРассчитыватьИтоги
	|ИЗ
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка	
			...
			Если РезультатПоСтатье.Колонки.Найти("НеРассчитыватьИтоги") = Неопределено Тогда
				РезультатПоСтатье.Колонки.Добавить("НеРассчитыватьИтоги", Новый ОписаниеТипов("Булево"));	
				Для Каждого РезультатПоСтатьеСтрока Из РезультатПоСтатье Цикл
					РезультатПоСтатьеСтрока.НеРассчитыватьИтоги = Выборка.НеРассчитыватьИтоги;
				КонецЦикла;
			КонецЕсли;
